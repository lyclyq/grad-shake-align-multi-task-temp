...
We report final validation accuracy at the selected cutoff step for six
single-task settings: DeBERTa/MRPC, DeBERTa/RTE, DeBERTa/SST-2,
RoBERTa/MRPC, RoBERTa/RTE, and RoBERTa/SST-2.
The \textbf{Overall} column is the unweighted mean across these six datasets.
We compare four lines: \textit{ours r}, \textit{ours R}, \textit{baseline r},
and \textit{baseline R}.

\begin{table}[H]
\centering
\caption{Final validation accuracy at the selected cutoff step. The
\textbf{Overall} column is the mean across all six datasets.}
\label{tab:final-val-acc}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lccccccc}
\toprule
Method & DeBERTa/MRPC & DeBERTa/RTE & DeBERTa/SST-2 & RoBERTa/MRPC & RoBERTa/RTE & RoBERTa/SST-2 & Overall \\
\midrule
ours r     & 0.8799 & \textbf{0.8195} & \textbf{0.9360} & \textbf{0.8863} & 0.7668 & 0.9298 & \textbf{0.8697} \\
ours R     & \textbf{0.8814} & 0.8166 & 0.9358 & 0.8848 & 0.7661 & \textbf{0.9300} & 0.8691 \\
baseline r & 0.8515 & 0.8130 & 0.9261 & 0.8765 & 0.7444 & 0.9264 & 0.8563 \\
baseline R & 0.8676 & 0.7675 & 0.9333 & 0.8696 & \textbf{0.7834} & 0.9032 & 0.8541 \\
\bottomrule
\end{tabular}%
}
\end{table}

Table~\ref{tab:final-val-acc} shows that the proposed method is competitive on
all datasets and achieves the best overall mean validation accuracy. In five of
the six datasets, either \textit{ours r} or \textit{ours R} attains the best
validation accuracy.

\begin{table}[H]
\centering
\caption{Mean validation-accuracy variance between seeds over the \emph{entire}
training process. The \textbf{Overall} column is the mean across all six
...
Method & DeBERTa/MRPC & DeBERTa/RTE & DeBERTa/SST-2 & RoBERTa/MRPC & RoBERTa/RTE & RoBERTa/SST-2 & Overall \\
\midrule
ours r     & 0.000700 & 0.000394 & 0.000173 & \textbf{0.000153} & 0.001092 & 0.000088 & \textbf{0.000433} \\
ours R     & 0.000711 & 0.000478 & 0.000156 & 0.000165 & 0.001117 & 0.000100 & 0.000455 \\
baseline r & 0.006457 & \textbf{0.000349} & 0.000151 & 0.000369 & \textbf{0.000691} & \textbf{0.000026} & 0.001340 \\
baseline R & \textbf{0.001023} & 0.005951 & \textbf{0.000005} & 0.000192 & 0.000776 & 0.000114 & 0.001344 \\
\bottomrule
\end{tabular}%
}
\end{table}

For the variance metric in Table~\ref{tab:seed-variance}, we do \textbf{not}
measure only the endpoint variance. Instead, we compute the validation-accuracy
variance \emph{between random seeds over the entire training process}, and then
report the mean variance over steps for each method line on each dataset. This
is therefore a full-process between-seed stability statistic.
